...
🚫نکته : بعد از دریافت این اعلان فقط⚠️ 24 ساعت ⚠️فرصت دارید اکانت رو تمدید کنید . درصورت باقی ماندن اشتراک بدون حجم یا زمان اکانت از سرور حذف خواهد شد و قابل تمدید نمیباشد .

آموزش تمدید یا شارژ اشتراک : 

اول روی دستور استارت کلیک کنید تا منوی اصلی ربات براتون باز شه 
👉🏻👉🏻👉🏻 /start  👈🏻👈🏻👈🏻

بعد از باز شدن منوی اصلی حالا روی بخش اکانت های من کلیک کنید ، سپس روی اسم اکانت مورد نظرتون کلیک کنید .

اگر فقط حجم ندارید از گزینه افزایش حجم سرویس استفاده کنید ، اگر زمان شما به اتمام رسیده از گزینه تمدید و شارژ مجدد سرویس استفاده کنید هم زمان و هم حجم شما ریست میشه یعنی اگر سرویس شما یک ماه چهل گیگ باشه مجدد 30 روز و 40 گیگ شارژ میشه سرویستون .";
...
آموزش خرید اشتراک جدید : 

اول روی دستور استارت کلیک کنید تا منوی اصلی ربات براتون باز شه 

👉🏻👉🏻👉🏻 /start  👈🏻👈🏻👈🏻

بعد از باز شدن منوی اصلی حالا روی بخش خرید اکانت جدید کلیک کنید ، سرویس مورد نظرتون رو انتخاب کنید و در انتها روش پرداخت خود را انتخاب و کنید و تمام اشتراک جدید براتون ارسال میشه !";
                    sendMessage( $msg, null, null, $from_id);
