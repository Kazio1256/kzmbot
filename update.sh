	...
	case $opt in
		...
		"Update panel")
			...
			echo "Folder created successfully!"
			 ...
			 cd /var/www/html/
			 wget -O wizwizpanel.zip https://github.com/kazio1256/kzmbot/releases/download/10.2.5/wizwizpanel.zip
		...
		"Backup")
			...
			wget https://raw.githubusercontent.com/kazio1256/kzmbot/main/dbbackupwizwiz.sh | chmod +x dbbackupwizwiz.sh
			./dbbackupwizwiz.sh
